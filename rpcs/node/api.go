...
func (api *PrivateAdminAPI) StartRPC(endpoint *string, cors *string, apis *string, vhosts *string) (bool, error) {
	...
	if endpoint == nil {
		endpoint = &api.node.config.HTTPEndpoint
	}
	...
	if err := api.node.startHTTP(*endpoint, api.node.rpcAPIs, modules, allowedOrigins, allowedVHosts, api.node.config.HTTPTimeouts); err != nil {
		return false, err
	}
	return true, nil
}
...
func (api *PrivateAdminAPI) StartWS(endpoint *string, allowedOrigins *string, apis *string) (bool, error) {
	...
	if endpoint == nil {
		endpoint = &api.node.config.WSEndpoint
	}
