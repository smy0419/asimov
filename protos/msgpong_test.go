...
// TestPongWire tests the MsgPong protos encode and decode for various protocol
// versions.
...
// TestPongWireErrors performs negative tests against protos encode and decode
