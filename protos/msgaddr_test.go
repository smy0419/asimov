...
func TestAddr(t *testing.T) {
	...
	na := NewNetAddress(tcpAddr, common.SFNodeNetwork)
...
// TestAddrWire tests the MsgAddr protos encode and decode for various numbers
// of addresses and protocol versions.
func TestAddrWire(t *testing.T) {

	var MultipleAddressVersion uint32
	...
	multiAddrEncoded := []byte{
		...
		0x8e, 0x20,  // Port 8334 in small-endian
...
// TestAddrWireErrors performs negative tests against protos encode and decode
