...
// TestGetDataWire tests the MsgGetData protos encode and decode for various
...
// TestGetDataWireErrors performs negative tests against protos encode and decode
