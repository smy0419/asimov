...
func TestFilterLoadMaxFilterSize(t *testing.T) {
	...
	err = msg.VVSDecode(readbuf, common.ProtocolVersion, BaseEncoding)
	if err == nil {
...
// TestFilterLoadWireErrors performs negative tests against protos encode and decode
...
func TestFilterLoadWireErrors(t *testing.T) {
	...
	baseFilterLoadEncoded := append(
		[]byte{0x00, 0x00, 0x00, 0x0a, // HashFuncs
		0x00, 0x00, 0x00, 0x00, // Tweak
		0x00, // Flags
		0x04, // baseFilter length
		}, baseFilter...)
