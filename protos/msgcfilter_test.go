...
var testMsgCFilterHash = common.Hash{
	0x6f, 0xe2, 0x8c, 0x0a, 0xb6, 0xf1, 0xb3, 0x72,
	0xc1, 0xa6, 0xa2, 0x46, 0xae, 0x63, 0xf7, 0x4f,
	0x93, 0x1e, 0x83, 0x65, 0xe1, 0x5a, 0x08, 0x9c,
	0x68, 0xd6, 0x19, 0x00, 0x00, 0x00, 0x00, 0x03, // PrevBlock
}
var testMsgCFilterdata = []byte{0xd6, 0x19, 0x00, 0x00,}

// TestMsgCFilter tests the MsgCFilter protos encode and decode for various
// numbers of headers and protocol versions.
func TestMsgCFilterSerialize(t *testing.T) {

	getCFilters := NewMsgCFilter(1,&testMsgCFilterHash,testMsgCFilterdata)
...
func TestMsgCFilterErrors(t *testing.T) {
	...
	tests := []struct {
		...
		// Force error in Data.
		{getCFilters, getCFiltersEncoded, pver, BaseEncoding, 33, io.ErrShortWrite, io.EOF},
	}
...
func TestMsgCFilterOverflowErrors(t *testing.T) {
	pver := uint32(0)
