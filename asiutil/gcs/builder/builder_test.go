...
var (
	...
	testAddr = "0x66ca348138ef2bec32528bf67678012833c2a56e1b"
...
func TestUseBlockHash(t *testing.T) {
	...
	hash, err :=  common.NewHashFromStr(testHash)
	if err != nil {
		t.Fatalf("Hash from string failed: %s", err.Error())
	}

	// common.IAddress
	addr, err := asiutil.DecodeAddress(testAddr)
	if err != nil {
...
func BuilderTest(b *builder.GCSBuilder, hash *common.Hash, p uint8, addrBytes []byte, t *testing.T) {
