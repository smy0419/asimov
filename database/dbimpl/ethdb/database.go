...
import (
	...
	"github.com/AsimovNetwork/asimov/vm/fvm/metrics"
...
// Enforce LDBDatabase implements the database.Database interface.
var _ database.Database = (*LDBDatabase)(nil)
...
func (db *LDBDatabase) Begin(writable bool) (database.Tx, error) {
	return nil, database.ErrUnimplement
}

func (db *LDBDatabase) View(fn func(tx database.Tx) error) error {
	return database.ErrUnimplement
}

func (db *LDBDatabase) Update(fn func(tx database.Tx) error) error {
	return database.ErrUnimplement
}
...
func (dt *table) Begin(writable bool) (database.Tx, error) {
	return dt.db.Begin( writable )
}

func (dt *table) View(fn func(tx database.Tx) error) error {
	return dt.db.View( fn )
}

func (dt *table) Update(fn func(tx database.Tx) error) error {
	return dt.db.Update( fn )
}
