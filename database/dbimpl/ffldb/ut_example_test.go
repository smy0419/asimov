...
//	// 	_ "github.com/AsimovNetwork/asimov/database/ffldb"
//	// )
//
...
//	db, err := ffldb.Create("ffldb", dbPath, types.MainNet)
//	if err != nil {
//		fmt.Println(err)
//		return
//	}
...
//		block := vvsutil.NewBlock( genesisBlock )
...
//	// protos.MsgBlock.Deserialize function or used in its serialized form
...
//
//	// Output:
//	// Serialized block size: 167658 bytes
//}
