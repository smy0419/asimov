...
func (bi *blockImporter) processBlock(serializedBlock []byte) (bool, error) {
	...
	block, err := asiutil.NewBlockFromBytes(serializedBlock)
	if err != nil {
		return false, err
	}
...
// and database.
func newBlockImporter(db database.Transactor, r io.ReadSeeker) *blockImporter {
