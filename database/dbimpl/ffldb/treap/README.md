...
[![GoDoc](https://godoc.org/github.com/AsimovNetwork/asimov/database/internal/treap?status.png)](http://godoc.org/github.com/AsimovNetwork/asimov/database/internal/treap)
...
operations are all O(logger n).  Both mutable and immutable variants are provided.
