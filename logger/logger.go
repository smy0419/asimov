...
// can't be interpreted as a valid logger level, the info level and false is
// returned.
...
// String returns the tag of the logger used in logger messages, or "OFF" if
// the level will not produce any logger output.
...
// temporary buffers for formatting logger messages prior to outputting them.
...
// print outputs a logger message to the writer associated with the backend after
...
// printf outputs a logger message to the writer associated with the backend after
// creating a prefix for the given level and tag according to the formatHeader
...
// Backend b.  A tag describes the subsystem and is included in all logger
...
// the prefix as necessary, and writes to logger with LevelTrace.
//
...
// necessary, and writes to logger with LevelTrace.
//
// This is part of the Logger interface implementation.
...
// the prefix as necessary, and writes to logger with LevelDebug.
//
// This is part of the Logger interface implementation.
...
// necessary, and writes to logger with LevelDebug.
//
// This is part of the Logger interface implementation.
...
// the prefix as necessary, and writes to logger with LevelInfo.
//
// This is part of the Logger interface implementation.
...
// necessary, and writes to logger with LevelInfo.
//
// This is part of the Logger interface implementation.
...
// the prefix as necessary, and writes to logger with LevelWarn.
//
// This is part of the Logger interface implementation.
...
// necessary, and writes to logger with LevelWarn.
//
// This is part of the Logger interface implementation.
...
// the prefix as necessary, and writes to logger with LevelError.
//
// This is part of the Logger interface implementation.
...
// necessary, and writes to logger with LevelError.
//
// This is part of the Logger interface implementation.
...
// the prefix as necessary, and writes to logger with LevelCritical.
//
// This is part of the Logger interface implementation.
...
// as necessary, and writes to logger with LevelCritical.
//
// This is part of the Logger interface implementation.
