...
// CallContext provides a basic interface for the FVM calling conventions. The FVM FVM
// depends on this context being implemented for doing subcalls and initialising new FVM contracts.
