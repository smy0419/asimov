...
// StructLog is emitted to the FVM each cycle and lists information about the current internal state
...
// Tracer is used to collect execution traces from an FVM transaction
...
func (l *StructLogger) CaptureState(env *FVM, pc uint64, op OpCode, gas, cost uint64, memory *Memory, stack *Stack, contract *Contract, depth int, err error) error {
	...
	// create a new snaptshot of the FVM.
