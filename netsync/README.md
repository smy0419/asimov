...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/AsimovNetwork/asimov/netsync)
...
```bash
$ go get -u github.com/AsimovNetwork/asimov/netsync
```
