...
import (
	...
	"github.com/AsimovNetwork/asimov/common/base58"
	"github.com/AsimovNetwork/asimov/common/bech32"
...
func NewAddressScriptHash(serializedScript []byte, net *Params) (*AddressScriptHash, error) {
	scriptHash := common.Hash160(serializedScript)
...
func (a *AddressPubKey) EncodeAddress() string {
	return encodeAddress(common.Hash160(a.serialize()), a.pubKeyHashID)
}
...
func (a *AddressPubKey) AddressPubKeyHash() *AddressPubKeyHash {
	...
	copy(addr.hash[:], common.Hash160(a.serialize()))
	return addr
}
...
func EncodePrivkey(privkey *crypto.PrivateKey, net *Params) string{
	...
	privKeyBytes = append(privKeyBytes, 1)
	return base58.CheckEncode(privKeyBytes, net.PrivateKeyID)
}
