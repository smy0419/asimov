...
var mainNetGenesisHash = Hash([HashLength]byte{ // Make go vet happy.
...
func TestHash(t *testing.T) {
	...
	hash = BytesToHash(blockHash.CloneBytes())
	if err != nil {
...
func TestHashString(t *testing.T) {
	...
	hash := Hash([HashLength]byte{ // Make go vet happy.
...
func TestNewHashFromStr(t *testing.T) {
	tests := []struct {
		...
		{
			"1",
			Hash([HashLength]byte{ // Make go vet happy.
